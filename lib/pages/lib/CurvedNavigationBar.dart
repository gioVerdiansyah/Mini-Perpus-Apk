...
class CurvedNavigationBar extends StatefulWidget {
  ...
  final Color? activeButtonLabelColor;
  ...
  CurvedNavigationBar({
    ...
    this.height = 68.0,
    this.curvedBackgroundColor,
    this.activeButtonLabelColor,
...
class CurvedNavigationBarState extends State<CurvedNavigationBar> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Material(
        color: widget.curvedBackgroundColor ?? Theme.of(context).colorScheme.background,
        child: Stack(
                ...
                child: Transform.translate(
                  ...
                  child: Material(
                    ...
                    child: Padding(
                        ...
                        child: Icon(
                          _icon.icon,
                          color: widget.activeButtonColor ?? widget.buttonBackgroundColor,
                          size: _icon?.size - 10 ?? 25,
                        )),
                  ),
                ),
              ),
              ...
              child: Center(
                child: Padding(
                  ...
                  child: Text(
                    _label,
                    style: TextStyle(
                        color: widget.activeButtonLabelColor ?? widget.buttonBackgroundColor, fontWeight: FontWeight.bold),
                    maxLines: 1,
                  ),
                ),
              ),
                          ...
                          children: [
                            ...
                            Align(
                              ...
                              child: Text(
                                item.label,
                                maxLines: 1,
                                style: TextStyle(color: widget.buttonLabelColor ?? widget.buttonBackgroundColor),
                              ),
                            ),
                          ],
                        ),
